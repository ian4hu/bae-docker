...
_init_env()
{
    if [ ! -L /home/admin/php/etc/php-fpm.conf ]; then
		ln -s /home/admin/runtime/php-fpm.conf /home/admin/php/etc/php-fpm.conf
    fi
    if [ ! -L /home/admin/php/etc/php.ini ]; then
	...
	if [ -f /home/bae/.user_profile ]; then 
...
_start()
{
	...
	/home/admin/php/sbin/php-fpm -y /home/admin/runtime/php-fpm.conf -c /home/admin/php/etc/php.ini -D
